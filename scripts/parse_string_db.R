...
ppi_df <- fread("Data/9606.protein.links.full.v12.0.txt.gz",header=T)
...
protein_info_df <- fread("Data/9606.protein.info.v12.0.txt.gz",header=T)
...
write.table(final_protein_df, file = "Data/StringDB_protein_info.csv",row.names=F, col.names=T, quote=F, sep=" | ")